...
// Crear cliente con TODOS los intents necesarios para IA, Moderación y Bienvenidas
const client = new Client({
    intents: [
        ...
        GatewayIntentBits.MessageContent // CRÍTICO: Para leer mensajes (IA, Anti-spam, Logs)
    ]
});
